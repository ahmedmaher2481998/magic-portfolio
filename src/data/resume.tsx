...
export const DATA = {
  name: "Ahmed Maher",
  initials: "AM",
  url: "https://www.a-maher938.vercel.app",
  location: "Egypt, BNS",
  locationLink: "https://www.google.com/maps/place/baniseuif",
  description:
  ...
  contact: {
    ...
    social: {
      GitHub: {
        name: "GitHub",
        url: "https://github.com/ahmedmaher2481998",
        icon: Icons.github,
        navbar: true,
      },
      LinkedIn: {
        name: "LinkedIn",
        url: "https://www.linkedin.com/in/ahmedmaher2481998/",
        icon: Icons.linkedin,
